...
//    connect(&m_stActAbout, &QAction::triggered, this, &MainWid::OnShowAbout);
   // connect(&m_s, &QAction::triggered, this, &MainWid::OnFullScreenPlay);
...
void MainWid::OnFullScreenPlay()
{
    if (m_bFullScreenPlay == false)
    {
        ...
        m_stCtrlbarAnimationShow->setDuration(500);
        ...
        m_stCtrlbarAnimationHide->setDuration(500);
       // Qt::FramelessWindowHint
        //
        ui->CtrlBarWid->setWindowFlags(Qt::Window  | Qt::FramelessWindowHint);
        ui->CtrlBarWid->windowHandle()->setScreen(pStCurScreen);
       // ui->CtrlBarWid->raise();//提升到当前的
       ...
       // qDebug() << "focus"<<this->focusWidget();
        ui->ShowWid->activateWindow(); //多加了一句这个
        ui->CtrlBarWid->raise();
       // qDebug() << "focus"<<this->focusWidget();
    ...
    else
    {
        ...
        ui->CtrlBarWid->setWindowOpacity(1); //设置透明度
        ui->CtrlBarWid->showNormal();
